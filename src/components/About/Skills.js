...
const Skills = () => {
    return (
        <section className="w-full flex flex-col border-b-2 border-solid border-dark dark:border-light
        text-dark dark:text-light p-5 xs:p-10 sm:p-12 md:p-16 lg:p-20">
